(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.currency = "&#36"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "$"; // Currency symbol as textual string
			this.paypalCurrency = "USD"; // PayPal's currency code
			this.paypalBusinessEmail = "castandblastmichigan@gmail.com"; // Your Business PayPal's account email address ***********SUPER IMPORTANT ECOMMERCE INTEGRATION!***********************************************************************************************************************************
			this.paypalURL = "https://www.paypal.com/paypal.me/CuccoCodes"; // The URL of the PayPal's form
